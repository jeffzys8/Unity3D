...
public class ISceneController : MonoBehaviour, SceneController, UserAction
{
    ...
    public LandController fromCoast;
    public LandController toCoast;
    ...
    public void loadResources()
    {
        ...
        fromCoast = new LandController("from");
        toCoast = new LandController("to");
    ...
    public void characterIsClicked(MyCharacterController characterCtrl)
    {
        ...
        {                                   // character on coast
            LandController whichCoast = characterCtrl.getCoastController();
